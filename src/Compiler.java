...
public class Compiler {
    ...
    public static void main(String[] args) {
        String dirPath = "C:/Users/zergl/IdeaProjects/JBGPL TreeBuilder/src/files/Jack Files/Test";
        File f = new File(dirPath + "/Test.jbgpl");
        String[] tokens = Tokenizer.tokenize(f);
        String[] classes = Compiler.classFinder(dirPath);

        TreeBuilder comp = new TreeBuilder(tokens, classes);
        String out = "";
        try {
            out = comp.classTree();
